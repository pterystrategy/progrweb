                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="situacao" id="situacaoHabilitado" value="1" <?php if ($usuario->getSituacao() == 1) {
                echo 'checked';
            } ?>>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="situacao" id="situacaoBloqueado" value="0" <?php if ($usuario->getSituacao() == 0) {
                echo 'checked';
            } ?>>
